const en = {
  ...
  socials: {
    ...
    pumpfun: 'Pump.fun',
    youtube: 'YouTube',
    xFeed: 'Follow me on X',
    xVisit: 'Visit my X profile to see the latest posts and updates.',
    instagramFeed: 'Follow me on Instagram',
    instagramVisit: 'Visit my Instagram profile to see the latest content and updates.',
    youtubeFeed: 'Subscribe on YouTube',
    youtubeVisit: 'Subscribe to my YouTube channel for videos and updates.',
    twitchFeed: 'Follow on Twitch',
    twitchVisit: 'Follow my Twitch channel for live streams and gaming content.',
    twitchLatest: 'Latest Twitch Stream',
    twitchPrevious: 'Previous Streams',
    pumpfunFeed: 'Watch me on Pump.fun',
    pumpfunTokenOverview: 'Stream Token Overview',
    pumpfunDescription: 'Dive into the latest stats for my stream token and check back soon for live updates.',
    pumpfunTokenLink: 'Token Link',
    pumpfunView: 'View on pump.fun',
    pumpfunMarketCap: 'Market Cap',
    pumpfunTicker: 'Ticker',
    pumpfun24hChange: '24h Change',
    pumpfun24hVolume: '24h Volume',
  },
  home: {
  ...
  contact: {
    ...
    topicLabel: 'Topic',
    topicPlaceholder: 'Project, coaching, or inquiry',
    emailButton: 'Email juanje1019@gmail.com',
    socialsHeading: 'Connect on socials',
    xTwitter: 'X / Twitter',
    instagram: 'Instagram',
    youtube: 'YouTube',
    tiktok: 'TikTok',
    callNote: 'Prefer a call? Mention it in your note and I will share a calendar link.',
    servicesNote: 'Looking for services? Visit the',
    servicesLink: 'Services page',
    servicesNote2: 'to see how we can work together.'
  },
  profile: {
    heading: 'User Profile',
    editProfile: 'Edit Profile',
    editProfileButton: 'Edit Profile',
    userProfile: 'Edit your profile information',
    ...
    socialMediaTwitter: 'X (Twitter) Username',
    twitterPlaceholder: 'yourusername (without @)',
    socialMediaDiscord: 'Discord Username',
    discordPlaceholder: 'your_discord_username (without @)',
    socialMediaTelegram: 'Telegram Username',
    telegramPlaceholder: 'yourusername (without @)',
    ...
    recommendedImage: 'Recommended: 500x500px, JPG or PNG, max 5MB',
    chooseImage: 'Choose Image',
    chooseImageLabel: 'Choose Image',
    uploadImage: 'Upload Image',
    connect: 'Connect',
    publicProfile: 'Public profile of {{username}}',
    memberBadge: 'Member',
    verifiedUser: '✓ Verified User',
    profilePictureAlt: 'Profile picture of {{username}}',
    contactOn: 'Contact {{platform}}',
  },
  privacy: {
    heading: 'Privacy Policy',
    subheading: 'How data is collected, used, and protected across this site and connected services.',
    adsenseHeading: 'AdSense disclosure',
    adsenseText: 'This site may display Google AdSense ads. AdSense uses cookies to deliver ads based on previous visits and interests. You can opt out of personalized ads through Google\'s Ads Settings.',
    cookiesHeading: 'Cookies and tracking',
    cookiesText: 'Cookies and similar technologies are used to keep the experience smooth—remembering preferences, measuring engagement, and improving page performance. You can disable cookies in your browser, but some features may feel slower or less personalized.',
    dataHeading: 'Data collection',
    dataText: 'Basic analytics capture anonymized usage data such as page views, device type, and general location. If you submit a form, your name and email are stored only long enough to respond to your request. No personal data is sold or shared with brokers.',
    partnersHeading: 'Third-party partners',
    partnersText: 'Embedded content and ad partners may set their own cookies and follow their respective privacy policies. Please review their notices for details on how they handle data and how to manage your preferences.',
    contactHeading: 'Contact',
    contactText: 'If you have questions about privacy or would like to request data removal, email',
    contactEmail: 'juanje1019@gmail.com'
  },
  career: {
    heading: 'Career',
    subheading: 'Professional software engineering career and technical expertise',
    web3Placeholder: 'Currently looking for part-time opportunities as a full stack developer within web3 teams and communities.',
    experiences: {
      optionCare: {
        ...
        description: 'Leading development efforts that improve patient-focused healthcare services and internal platforms.',
      },
      fedex: {
        ...
        description: 'Developed data-driven solutions and backend services for logistics and supply chain optimization.',
      },
      jbhunt: {
        title: 'Software Engineer II',
  ...
  football: {
    ...
    headingWeb3: 'Content Creator',
    subheading: 'Semi-pro and college soccer career, plus youth coaching experience',
    subheadingWeb3: 'Content creation and community building in Web3',    experiences: {
      alexandriaReds: {
        title: 'UPSL Soccer Player',
        company: 'Alexandria Reds',
        location: 'Alexandria, Virginia, United States',
        date: 'Apr 2025 - Aug 2025',
        description: 'Center midfielder and outside back for Alexandria Reds, a semi-professional team.',
        skills: ['Soccer', 'Leadership', 'Football'],
      },
      villarreal: {
        ...
        description: 'Director and Coach for the U15, U16, and U17 teams. Director and Coach for the Junior Academy.',
      ...
      villarealPlayer: {
        ...
        description: 'Captain center midfielder of the semi-professional Villarreal VA Academy team.',
        skills: ['Soccer', 'Leadership', 'Football'],
      },
      sycCoach: {
      ...
      sycPlayer: {
        ...
        location: 'Springfield, Virginia, United States',
        date: 'Jul 2022 - Jul 2023',
        description: 'Outside back for the semi-professional SYC United team.',
        skills: ['Soccer', 'Leadership', 'Football'],
      },
      waynesboro: {
        title: 'Head JV Coach',
        ...
        description: 'Coach of the JV soccer team, focused on skill development and team building.',
      },
      shenandoah: {
        title: 'Head Soccer Coach',
        ...
        description: 'Head coach of a U17 soccer team competing in the CCL.',
      },
      horizonsEdge: {
        title: 'U23 Professional Soccer Player',
        company: 'Horizons Edge Sports Campus',
        location: 'Harrisonburg, Virginia, United States',
        date: 'Mar 2021 - Jul 2021',
        description: 'Captain center midfielder and outside back for Horizons Edge United men\'s team.',
        skills: ['Soccer', 'Leadership', 'Football'],
      },
      emu: {
        title: 'D3 Collegiate Soccer Player',
        company: 'Eastern Mennonite University',
        location: 'Harrisonburg, Virginia, United States',
        date: 'Aug 2016 - Jan 2020',
        description: 'Outside back for the EMU men\'s soccer team.',
        skills: ['Soccer', 'Leadership', 'Football'],
      },
    },
  },
  contentCreator: {
    ...
    subheading: 'Community building and education in Web3',
    experiences: {
      sns: {
        ...
        description: 'Supporting the SNS community by promoting .sol adoption, educating new users, and amplifying native Solana projects.',
      },
      devFun: {
        title: 'Project Scout',
        company: 'Dev.Fun',
        ...
        description: 'Project Scout for Dev.Fun, driving ICM (Initial Coin Machine) on Pump.fun. Prospecting and evaluating innovative blockchain projects.',
      },
    },  },
  trading: {
  ...
  blog: {
    heading: 'Blog',
    headingWeb3: 'Blog',
    subheading: 'Long-form articles will be published here after the writing schedule is finalized.',
  ...
  cookie: {
    ...
    description: 'We use cookies to enhance your browsing experience, personalize content, and analyze site traffic. Some cookies are essential for functionality, while others help us improve your experience.',
    details: 'For more information about how we use cookies and your privacy, please review our',
    ...
    cancel: 'Cancel',
    preferencesDescription: 'Choose which types of cookies you want to allow. Essential cookies are always required and cannot be disabled.',
    essentialTitle: 'Essential Cookies',
    essentialDescription: 'These cookies are necessary for the website to function properly. They enable core functionality such as page navigation, security, and access to secure areas.',
    analyticsTitle: 'Analytics Cookies',
    analyticsDescription: 'Analytics cookies help us understand how visitors interact with our website by collecting and reporting information anonymously.',
    marketingTitle: 'Marketing & Social Media Cookies',
    marketingDescription: 'These cookies are used to track visitors across websites and display personalized ads on social media platforms and other sites.',
    enabled: 'Enabled',
    disabled: 'Disabled',
    always: 'Always On'
  }
