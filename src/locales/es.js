const es = {
  ...
  hero: {
    intro: {
      web3:
        'Juangunner4.sol/sui codificando, troleando, operando, jugando y construyendo cultura.',
      web2: 'Futbolista e ingeniero de software.'
    },
    links: {
    ...
    randomTrade: {
      headingWeb3: 'Enlace destacado de trading Web3',
      headingWeb2: 'Enlace destacado de inversión',
      ariaLabel: 'Abrir referido de {{platform}}',
    }
  },
  about: {
    heading: 'Carrera y Trading',
    ...
    trade: {
      ...
      details: {
        heading: 'Plataforma de trading',
        backToList: 'Volver a los enlaces de trading',
      },
      categories: {
        invest: {
        ...
        trade: {
          ...
          platforms: {
            ...
            jupiter: {
              name: 'Jupiter',
              description:
                'Código de referido para el Jupiter Trading Card Game en Solana. Refer & Trade to Earn desde $1,000,000 en recompensas. El evento va del 11 de diciembre de 2025 a las 02:00 AM al 31 de enero de 2026 a las 06:59 PM (2 meses).',
              linkLabel: 'Únete al Jupiter Trading Card Game',
            },
            lulo: {
              name: 'Lulo Finance',
              description:
            ...
            wallchain: {
              name: 'Wallchain.xyz',
              description:
                'Wallchain impulsa Quacks, una red de trading social para creadores on-chain y constructores de mindshare. Únete con mi referido para sincronizarte con la bandada.',
              linkLabel: 'Entra a Wallchain vía Quacks',
            },
            backpack: {
  ...
  timeline: {
    ...
    errorPosts: 'Error cargando publicaciones.',
    noPosts: 'No hay publicaciones para mostrar.',
    loadingTweets: 'Cargando tweets...',
    errorTweets: 'Error cargando tweets.',
    visitProfile: 'Visitar perfil',
    noTweets: 'No hay tweets para mostrar.',
    loadingStreams: 'Cargando streams...',
    errorStreams: 'Error cargando streams.',
    noStreams: 'No hay streams para mostrar.',
    loadingVideos: 'Cargando vídeos...',
    errorVideos: 'Error cargando vídeos.',
    noVideos: 'No hay vídeos para mostrar.',
    noTimeline: 'No hay contenido disponible.'
  },
  socials: {
    x: 'X',
    instagram: 'Instagram',
    ...
    youtube: 'YouTube',
    xFeed: 'Sígueme en X',
    xVisit: 'Visita mi perfil de X para ver las últimas publicaciones y actualizaciones.',
    instagramFeed: 'Sígueme en Instagram',
    instagramVisit: 'Visita mi perfil de Instagram para ver el contenido más reciente y actualizaciones.',
    youtubeFeed: 'Suscríbete en YouTube',
    youtubeVisit: 'Suscríbete a mi canal de YouTube para videos y actualizaciones.',
    twitchFeed: 'Sígueme en Twitch',
    twitchVisit: 'Sigue mi canal de Twitch para transmisiones en vivo y contenido de gaming.',
    twitchLatest: 'Última Transmisión en Twitch',
    twitchPrevious: 'Transmisiones Anteriores',
    pumpfunFeed: 'Mírame en Pump.fun',
    pumpfunTokenOverview: 'Resumen del Token de Transmisión',
    pumpfunDescription: 'Sumérgete en las últimas estadísticas de mi token de transmisión y regresa pronto para actualizaciones en vivo.',
    pumpfunTokenLink: 'Enlace del Token',
    pumpfunView: 'Ver en pump.fun',
    pumpfunMarketCap: 'Capitalización de Mercado',
    pumpfunTicker: 'Símbolo',
    pumpfun24hChange: 'Cambio en 24h',
    pumpfun24hVolume: 'Volumen en 24h',
  },
  home: {
  ...
  contact: {
    heading: 'Calendario',
    subheading: 'Programa una llamada conmigo. Los horarios disponibles se muestran a continuación.',
    timezoneNote: 'Todas las horas se muestran en tu zona horaria local.',
    formHeading: 'Envía una nota rápida',
    formDescription: 'Deja tu información y te responderé con los siguientes pasos.',
    nameLabel: 'Nombre',
    namePlaceholder: 'Tu nombre',
    emailLabel: 'Correo electrónico',
    emailPlaceholder: 'tu@ejemplo.com',
    topicLabel: 'Tema',
    topicPlaceholder: 'Proyecto, entrenamiento o consulta',
    emailButton: 'Enviar correo a juanje1019@gmail.com',
    socialsHeading: 'Conéctate en redes sociales',
    xTwitter: 'X / Twitter',
    instagram: 'Instagram',
    youtube: 'YouTube',
    tiktok: 'TikTok',
    callNote: '¿Prefieres una llamada? Menciónalo en tu nota y compartiré un enlace de calendario.',
    servicesNote: '¿Buscas servicios? Visita la',
    servicesLink: 'página de Servicios',
    servicesNote2: 'para ver cómo podemos trabajar juntos.'
  },
  profile: {
    heading: 'Perfil del usuario',
    editProfile: 'Editar perfil',
    editProfileButton: 'Editar perfil',
    userProfile: 'Edita tu información de perfil',
    ...
    socialMediaTwitter: 'Usuario de X (Twitter)',
    twitterPlaceholder: 'tunombre (sin @)',
    socialMediaDiscord: 'Usuario de Discord',
    discordPlaceholder: 'tu_usuario_discord (sin @)',
    socialMediaTelegram: 'Usuario de Telegram',
    telegramPlaceholder: 'tunombre (sin @)',
    ...
    recommendedImage: 'Recomendado: 500x500px, JPG o PNG, máx 5MB',
    chooseImage: 'Seleccionar imagen',
    chooseImageLabel: 'Seleccionar imagen',
    uploadImage: 'Subir imagen',
    connect: 'Conectar',
    publicProfile: 'Perfil público de {{username}}',
    memberBadge: 'Miembro',
    verifiedUser: '✓ Usuario verificado',
    profilePictureAlt: 'Foto de perfil de {{username}}',
    contactOn: 'Contacto en {{platform}}',
  },
  privacy: {
    heading: 'Política de Privacidad',
    subheading: 'Cómo se recopilan, usan y protegen los datos en este sitio y servicios conectados.',
    adsenseHeading: 'Divulgación de AdSense',
    adsenseText: 'Este sitio puede mostrar anuncios de Google AdSense. AdSense usa cookies para entregar anuncios basados en visitas e intereses previos. Puedes optar por no recibir anuncios personalizados a través de la configuración de anuncios de Google.',
    cookiesHeading: 'Cookies y seguimiento',
    cookiesText: 'Las cookies y tecnologías similares se utilizan para mantener la experiencia fluida: recordar preferencias, medir el compromiso y mejorar el rendimiento de la página. Puedes deshabilitar las cookies en tu navegador, pero algunas funciones pueden sentirse más lentas o menos personalizadas.',
    dataHeading: 'Recopilación de datos',
    dataText: 'Los análisis básicos capturan datos de uso anónimos como vistas de página, tipo de dispositivo y ubicación general. Si envías un formulario, tu nombre y correo electrónico se almacenan solo el tiempo necesario para responder a tu solicitud. No se venden ni comparten datos personales con intermediarios.',
    partnersHeading: 'Socios externos',
    partnersText: 'El contenido incrustado y los socios de anuncios pueden establecer sus propias cookies y seguir sus respectivas políticas de privacidad. Revisa sus avisos para obtener detalles sobre cómo manejan los datos y cómo administrar tus preferencias.',
    contactHeading: 'Contacto',
    contactText: 'Si tienes preguntas sobre privacidad o deseas solicitar la eliminación de datos, envía un correo a',
    contactEmail: 'juanje1019@gmail.com'
  },
  career: {
    heading: 'Carrera',
    subheading: 'Carrera profesional en ingeniería de software y experiencia técnica',
    web3Placeholder: 'Actualmente busco oportunidades de medio tiempo como desarrollador full stack en equipos y comunidades web3.',
    experiences: {
      optionCare: {
        ...
        description: 'Liderando esfuerzos de desarrollo que mejoran los servicios de atención médica centrados en el paciente y plataformas internas.',
      },
      fedex: {
        title: 'Ingeniero de Software II',
        company: 'FedEx Dataworks',
        location: 'Remoto',
        date: 'Jun 2024 - Dic 2025',
        description: 'Desarrollé soluciones impulsadas por datos y servicios de backend para optimización de logística y cadena de suministro.',
      },
      jbhunt: {
        title: 'Ingeniero de Software II',
        company: 'J.B. Hunt Transport Services, Inc.',
        location: 'Lowell, Arkansas, Estados Unidos',
        date: 'Ago 2022 - Jun 2024',
        description: 'Desarrollé y mantuve APIs usando Quarkus y Spring Boot. Implementé microservicios en Azure usando Kubernetes Lens.',
        responsibilities: [
          'Desarrollé y actualicé APIs usando Quarkus y Spring Boot.',
          'Usé Azure y Kubernetes Lens para implementación.',
          'Practiqué estándares de codificación modernos con pruebas JUnit.',
          'Completé capacitación en desarrollo frontend en Angular.',
        ],
      },
      freddieMac: {
        title: 'Desarrollador Ágil, Asociado II',
        company: 'Freddie Mac',
        location: 'McLean, Virginia, Estados Unidos',
        date: 'Nov 2020 - Ago 2022',
        description: 'Desarrollé y modernizé aplicaciones usando TDD con Spring Boot y Jenkins.',
        responsibilities: [
          'Usé Spring Boot Java Framework para desarrollar y actualizar APIs.',
          'Practiqué Desarrollo Dirigido por Pruebas (TDD).',
          'Implementé aplicaciones usando Jenkins y OpenShift.',
        ],
      },
      naturalGarden: {
        title: 'Consultor Técnico',
        company: 'The Natural Garden, Inc.',
        location: 'Harrisonburg, Virginia, Estados Unidos',
        date: 'May 2019 - Ene 2022',
        description: 'Resolví problemas técnicos e implementé actualizaciones de red para productividad.',
        responsibilities: [
          'Resolví problemas relacionados con macOS, Windows, Google Admin y administración de redes.',
          'Actualicé la red WiFi y las computadoras del personal.',
        ],
      },
      mthree: {
        title: 'Asociado Alumno',
        company: 'mthree',
        location: 'Remoto',
      ...
      emu: {
        title: 'Técnico de Puntos Finales',
        company: 'Eastern Mennonite University',
        location: 'Harrisonburg, Virginia, Estados Unidos',
        date: 'Jun 2019 - May 2020',
        responsibilities: [
          'Administré entornos Apple y Windows a través de Jamf Pro y Fog.',
          'Proporcioné servicios de configuración, pruebas, instalación y mantenimiento.',
          'Administré impresora 3D, usando Autodesk Inventor para diseño de piezas.',
        ],
      },
      emuTutor: {
        ...
        company: 'Eastern Mennonite University',
        location: 'Harrisonburg, Virginia, Estados Unidos',
        date: 'Ago 2019 - Ene 2020',
        description: 'Enseñé a estudiantes Python para un curso introductorio de programación.',
      },
    },
  },
  football: {
    heading: 'Carrera en Fútbol',
    headingWeb3: 'Creador de Contenido',
    subheading: 'Carrera de fútbol semi-pro y universitario, más experiencia en entrenamiento juvenil',
    subheadingWeb3: 'Creación de contenido y construcción de comunidad en Web3',
    experiences: {
      alexandriaReds: {
        title: 'Jugador de Fútbol UPSL',
        company: 'Alexandria Reds',
        location: 'Alexandria, Virginia, Estados Unidos',
        date: 'Abr 2025 - Ago 2025',
        description: 'Centrocampista y lateral de la Alexandria Reds, equipo semi-profesional.',
        skills: ['Fútbol', 'Liderazgo', 'Soccer'],
      },
      villarreal: {
        title: 'Entrenador Principal de Fútbol Juvenil',
        company: 'Villarreal CF, SAD',
        location: 'Falls Church, Virginia, Estados Unidos',
        date: 'Abr 2023 - Abr 2025',
        description: 'Director y entrenador de categorías 2015, 2016 y 2017. Director y entrenador de la Academia Junior.',
        skills: ['Coaching de Deportes', 'Atletismo', 'Fútbol'],
      },
      villarealPlayer: {
        title: 'Jugador de Fútbol UPSL',
        ...
        description: 'Centrocampista capitán del equipo semi-profesional Villarreal VA Academy.',
        skills: ['Fútbol', 'Liderazgo', 'Soccer'],
      },
      sycCoach: {
        title: 'Entrenador Principal de Fútbol',
        company: 'Springfield/South County Youth Club',
        location: 'Springfield, Virginia, Estados Unidos',
        date: 'Jul 2022 - Jul 2023',
        skills: ['Coaching de Deportes', 'Gestión Deportiva', 'Atletismo', 'Fútbol'],
      },
      sycPlayer: {
        title: 'Jugador de Fútbol UPSL',
        company: 'Springfield/South County Youth Club',
        location: 'Springfield, Virginia, Estados Unidos',
        date: 'Jul 2022 - Jul 2023',
        description: 'Lateral del equipo semi-profesional SYC United.',
        skills: ['Fútbol', 'Liderazgo', 'Soccer'],
      },
      waynesboro: {
        title: 'Entrenador Principal de JV',
        company: 'Waynesboro High School',
        location: 'Waynesboro, Virginia, Estados Unidos',
        date: 'Feb 2021 - Jun 2021',
        description: 'Entrenador del equipo de fútbol JV, enfocado en desarrollo de habilidades y trabajo en equipo.',
      },
      shenandoah: {
        title: 'Entrenador Principal de Fútbol',
        ...
        description: 'Entrenador principal de un equipo de fútbol sub-17 que juega en la CCL.',
      },
      horizonsEdge: {
        title: 'Jugador de Fútbol Profesional U23',
        company: 'Horizons Edge Sports Campus',
        location: 'Harrisonburg, Virginia, Estados Unidos',
        date: 'Mar 2021 - Jul 2021',
        description: 'Centrocampista capitán y lateral del equipo de hombres Horizons Edge United.',
        skills: ['Fútbol', 'Liderazgo', 'Soccer'],
      },
      emu: {
        title: 'Jugador de Fútbol Colegiado D3',
        company: 'Eastern Mennonite University',
        location: 'Harrisonburg, Virginia, Estados Unidos',
        date: 'Ago 2016 - Ene 2020',
        description: 'Lateral del equipo de fútbol de hombres EMU.',
        skills: ['Fútbol', 'Liderazgo', 'Soccer'],
      },
    },
  },
  contentCreator: {
    heading: 'Creador de Contenido',
    subheading: 'Construcción de comunidad y educación en Web3',
    experiences: {
      sns: {
        title: 'Embajador SNS',
        ...
        description: 'Apoyo a la comunidad SNS promoviendo la adopción de .sol, educando a nuevos usuarios y amplificando proyectos nativos de Solana.',
      },
      devFun: {
        title: 'Project Scout',
        company: 'Dev.Fun',
        ...
        description: 'Project Scout para Dev.Fun, impulsando ICM (Initial Coin Machine) en Pump.fun. Prospectando y evaluando proyectos blockchain innovadores.',
      },
    },
  },
  trading: {
  ...
  blog: {
    heading: 'Blog',
    headingWeb3: 'Blog',
    subheading: 'Artículos de formato largo se publicarán aquí después de finalizar el calendario de escritura.',
  ...
  cookie: {
    ...
    description: 'Utilizamos cookies para mejorar tu experiencia de navegación, personalizar contenido y analizar el tráfico del sitio. Algunas cookies son esenciales para la funcionalidad, mientras que otras nos ayudan a mejorar tu experiencia.',
    details: 'Para obtener más información sobre cómo usamos cookies y tu privacidad, consulta nuestra',
    ...
    cancel: 'Cancelar',
    preferencesDescription: 'Elige qué tipos de cookies deseas permitir. Las cookies esenciales siempre son necesarias y no se pueden desactivar.',
    essentialTitle: 'Cookies Esenciales',
    essentialDescription: 'Estas cookies son necesarias para que el sitio web funcione correctamente. Permiten funcionalidades básicas como navegación de página, seguridad y acceso a áreas seguras.',
    analyticsTitle: 'Cookies de Análisis',
    analyticsDescription: 'Las cookies de análisis nos ayudan a comprender cómo interactúan los visitantes con nuestro sitio web recopilando e informando información de forma anónima.',
    marketingTitle: 'Cookies de Marketing y Redes Sociales',
    marketingDescription: 'Estas cookies se utilizan para rastrear a los visitantes en sitios web y mostrar anuncios personalizados en plataformas de redes sociales y otros sitios.',
    enabled: 'Habilitado',
